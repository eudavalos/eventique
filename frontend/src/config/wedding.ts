...
export const config: WeddingConfig = {
  ...
  venues: {
    ceremony: {
      ...
      photo: '/photos/ceremony-venue.jpg',
      time: '4:00 PM',
      dresscode: 'Formal',
    ...
    reception: {
      ...
      photo: '/photos/reception-venue.jpg',
      time: '7:00 PM',
      dresscode: 'Formal',
  ...
  sections: {
    ...
    ourStory: {
      ...
      events: [
        ...
        },
        {
          ...
          title: 'La Propuesta',
          description:
            'Bajo las estrellas en la bahía de Cartagena, con la ciudad amurallada como testigo, Carlos le preguntó a Ana lo que cambiaría sus vidas para siempre.',
    ...
    weddingParty: {
      ...
      members: [
        { name: 'Valentina Ramos', role: 'Madrina de Honor', side: 'bride', photo: '/photos/party-1.jpg' },
        { name: 'Sofía Castro', role: 'Dama de Honor', side: 'bride', photo: '/photos/party-2.jpg' },
        { name: 'Isabela Torres', role: 'Dama de Honor', side: 'bride', photo: '/photos/party-3.jpg' },
        { name: 'Santiago Pérez', role: 'Padrino de Honor', side: 'groom', photo: '/photos/party-4.jpg' },
        { name: 'Andrés Mora', role: 'Caballero de Honor', side: 'groom', photo: '/photos/party-5.jpg' },
        { name: 'Felipe Vargas', role: 'Caballero de Honor', side: 'groom', photo: '/photos/party-6.jpg' },
      ],
    },
    ...
    gallery: {
      ...
      photos: [
        { url: '/photos/gallery-1.jpg', alt: 'Concepción y Eumelio' },
        { url: '/photos/gallery-2.jpg', alt: 'Paseo por la ciudad amurallada' },
        { url: '/photos/gallery-3.jpg', alt: 'Atardecer en la bahía' },
        { url: '/photos/gallery-4.jpg', alt: 'Juntos en la Sierra Nevada' },
        { url: '/photos/gallery-5.jpg', alt: 'La propuesta' },
        { url: '/photos/gallery-6.jpg', alt: 'Celebración del compromiso' },
        { url: '/photos/gallery-7.jpg', alt: 'Nuestra primera aventura' },
        { url: '/photos/gallery-8.jpg', alt: 'Amor en cada mirada' },
      ],
    },
