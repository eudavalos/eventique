...
export function mergeConfig(base: WeddingConfig, dynamic: Partial<EventConfig>): WeddingConfig {
  ...
  return {
    ...
    botanical_art_enabled:        (dyn.botanical_art_enabled as boolean | undefined)        ?? base.botanical_art_enabled ?? true,
    botanical_art_style:          (dyn.botanical_art_style as string | undefined)          ?? base.botanical_art_style ?? 'watercolor-eucalyptus',
    botanical_art_density:        (dyn.botanical_art_density as string | undefined)        ?? base.botanical_art_density ?? 'balanced',
    botanical_art_opacity:        (dyn.botanical_art_opacity as number | undefined)        ?? base.botanical_art_opacity ?? 0.62,
    botanical_art_card_decor_enabled: (dyn.botanical_art_card_decor_enabled as boolean | undefined) ?? base.botanical_art_card_decor_enabled ?? true,
